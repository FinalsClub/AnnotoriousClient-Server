...
Annotator.Plugin.Touch = (function(_super) {
  ...
  Touch.prototype.createAnnotation = function(range, quote) {
    var annotation;
    this.annotator.selectedRanges = [range];
    annotation = this.annotator.setupAnnotation(this.annotator.createAnnotation());
    annotation.quote = quote || range.text();
    return annotation;
  };
  ...
  Touch.prototype._palateMouseDown = function(e) {
    var offset, wrapper;
    ...
    return jQuery('#annotator-palate').css({
      top: e.pageY + 30,
  ...
  Touch.prototype._setupControls = function() {
    ...
    this.palate = jQuery(this.palate_t).appendTo("body");
